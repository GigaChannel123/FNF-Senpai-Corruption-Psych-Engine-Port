...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var watchable:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('watchable'));
		watchable.updateHitbox();
		watchable.screenCenter(Y);
		watchable.x = 750;
		watchable.antialiasing = ClientPrefs.globalAntialiasing;
		add(watchable);
		...
		txtTracklist = new FlxText(FlxG.width * 0.05, tracksSprite.y + 9999999990, 0, "", 32);
